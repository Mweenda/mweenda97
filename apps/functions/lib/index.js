 ...
 */
export const api = functions.https.onRequest(createHTTPHandler({
    router: appRouter,
    createContext: () => ({
        firestore: db,
    }),
 ...
 */
export const captureLeadHandler = functions.https.onCall(async (data, context) => {
    try {
 ...
 */
export const initTerminalSessionHandler = functions.https.onCall(async (_data, context) => {
    try {
 ...
 */
export const executeTerminalCommandHandler = functions.https.onCall(async (data, _context) => {
    try {
